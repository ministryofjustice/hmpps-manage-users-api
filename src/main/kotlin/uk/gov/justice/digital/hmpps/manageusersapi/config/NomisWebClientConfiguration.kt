...
class NomisWebClientConfiguration(appContext: ApplicationContext) :
  ...
  @Bean
  fun nomisUserWebExtendedTimeoutClient(builder: Builder) = getWebClientExtendedTimeoutWithCurrentUserToken(builder)
  ...
  @Bean
  fun nomisUserWebExtendedTimeoutClientUtils(nomisUserWebClient: WebClient) = WebClientUtils(nomisUserWebClient, maxRetryAttempts)
}
